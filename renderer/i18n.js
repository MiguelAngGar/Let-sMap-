...
const T = {
  ...
  en: {
    ...
    'bpm.outro.more': "Half a second more of appended silence",
    'bpm.outro.reset': "Back to the {secs} s the app worked out",
    'bpm.outro.less': "Half a second less — at 0 the ending is left exactly as it is",
    ...
    'offset.beat1':       "beat 1",
    'offset.outro':            "outro silence",
    'offset.outro_title':      "Silence appended after the song. The song itself ends with {own} s, so the map will end with {total} s.",
  ...
  es: {
    ...
    'bpm.outro.more': "Medio segundo más de silencio añadido",
    'bpm.outro.reset': "Volver a los {secs} s que calculó la app",
    'bpm.outro.less': "Medio segundo menos; en 0 el final se deja tal cual",
    ...
    'offset.beat1':       "beat 1",
    'offset.outro':            "silencio final",
    'offset.outro_title':      "Silencio que se añade tras la canción. La canción acaba con {own} s de por sí, así que el mapa acabará con {total} s.",
  ...
  fr: {
    ...
    'bpm.outro.more': "Une demi-seconde de silence ajouté en plus",
    'bpm.outro.reset': "Revenir aux {secs} s calculées par l'app",
    'bpm.outro.less': "Une demi-seconde de moins ; à 0 la fin est laissée telle quelle",
    ...
    'offset.outro':            "silence de fin",
    'offset.outro_title':      "Silence ajouté après la chanson. Elle finit déjà par {own} s, donc la map finira par {total} s.",
  ...
  de: {
    ...
    'bpm.outro.more': "Eine halbe Sekunde mehr angehängte Stille",
    'bpm.outro.reset': "Zurück zu den {secs} s, die die App errechnet hat",
    'bpm.outro.less': "Eine halbe Sekunde weniger; bei 0 bleibt das Ende, wie es ist",
    ...
    'offset.beat1':       "Beat 1",
    'offset.outro':            "Outro-Stille",
    'offset.outro_title':      "Stille, die nach dem Song angehängt wird. Der Song endet selbst mit {own} s, die Map also mit {total} s.",
  ...
  pt: {
    ...
    'bpm.outro.more': "Meio segundo mais de silêncio acrescentado",
    'bpm.outro.reset': "Voltar aos {secs} s que a app calculou",
    'bpm.outro.less': "Meio segundo menos; em 0 o fim fica tal como está",
    ...
    'offset.beat1':       "beat 1",
    'offset.outro':            "silêncio final",
    'offset.outro_title':      "Silêncio acrescentado depois da música. A música acaba com {own} s por si, logo o mapa acabará com {total} s.",
