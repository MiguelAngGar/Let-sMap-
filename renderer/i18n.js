...
const T = {
  ...
  en: {
    ...
    'bpm.kb_hint':               "Space",
    'bpm.speed_hint':  "+ / −",
    'bpm.speed_title': "Preview speed — + and − change it, 0 goes back to 1×. The exported map always keeps the original speed.",
    'bpm.unit':                  "BPM",
    ...
    'wave.band.added':  "added silence",
    'wave.band.offset': "offset",
    'wave.band.outro':  "outro",
    'wave.beat':  "beat",
    'wave.beats': "beats",
    'offset.nudge': "offset",
    ...
    'meta.cover.box_title':  "Drop an image here, or click to choose one",
    'meta.cover.drop_short': "Drop or click",
  ...
  es: {
    ...
    'bpm.kb_hint':               "Espacio",
    'bpm.speed_hint':  "+ / −",
    'bpm.speed_title': "Velocidad de la previsualización — + y − la cambian, 0 vuelve a 1×. El mapa exportado siempre mantiene la velocidad original.",
    'bpm.unit':                  "BPM",
    ...
    'wave.band.added':  "silencio añadido",
    'wave.band.offset': "offset",
    'wave.band.outro':  "outro",
    'wave.beat':  "beat",
    'wave.beats': "beats",
    ...
    'meta.cover.box_title':  "Arrastra una imagen aquí, o haz clic para elegirla",
    'meta.cover.drop_short': "Arrastra o clic",
  ...
  fr: {
    ...
    'bpm.kb_hint':               "Espace",
    'bpm.speed_hint':  "+ / −",
    'bpm.speed_title': "Vitesse de la prévisualisation — + et − la changent, 0 revient à 1×. La map exportée garde toujours la vitesse d'origine.",
    'bpm.unit':                  "BPM",
    ...
    'wave.band.added':  "silence ajouté",
    'wave.band.offset': "offset",
    'wave.band.outro':  "outro",
    'wave.beat':  "temps",
    'wave.beats': "temps",
    ...
    'meta.cover.box_title':  "Glissez une image ici, ou cliquez pour en choisir une",
    'meta.cover.drop_short': "Glissez ou cliquez",
  ...
  de: {
    ...
    'bpm.speed_hint':  "+ / −",
    'bpm.speed_title': "Vorschau-Geschwindigkeit — + und − ändern sie, 0 setzt auf 1× zurück. Die exportierte Map behält immer die Originalgeschwindigkeit.",
    'bpm.unit':                  "BPM",
    ...
    'wave.band.added':  "zusätzliche Stille",
    'wave.band.offset': "Offset",
    'wave.band.outro':  "Outro",
    'wave.beat':  "Beat",
    'wave.beats': "Beats",
    ...
    'meta.cover.box_title':  "Bild hierher ziehen oder klicken, um eines zu wählen",
    'meta.cover.drop_short': "Ziehen o. klicken",
  ...
  pt: {
    ...
    'bpm.kb_hint':               "Espaço",
    'bpm.speed_hint':  "+ / −",
    'bpm.speed_title': "Velocidade da pré-visualização — + e − mudam-na, 0 volta a 1×. O mapa exportado mantém sempre a velocidade original.",
    'bpm.unit':                  "BPM",
    'bpm.custom.placeholder':    "Personalizado…",
    'bpm.section.candidates':    "Candidatos",
    'bpm.candidates.main':       "Detectado",
    ...
    'wave.band.added':  "silêncio adicionado",
    'wave.band.offset': "offset",
    'wave.band.outro':  "outro",
    'wave.beat':  "beat",
    'wave.beats': "beats",
    ...
    'meta.cover.box_title':  "Arrasta uma imagem para aqui, ou clica para escolher uma",
    'meta.cover.drop_short': "Arrasta ou clica",
...
function apply() {
  ...
  document.querySelectorAll('[data-i18n-title]').forEach(el => {
    ...
    el.title = label
    // Controls whose face is just a symbol or an image need the same text for
    // screen readers — real buttons and anything acting as one (the cover box).
