...
const T = {
  ...
  en: {
    ...
    'bpm.outro.more': "Half a second more of silence at the end",
    'bpm.outro.less': "Half a second less of silence at the end",
    'bpm.outro.none': "Nothing to remove — this is the silence the song itself ends with",
    ...
    'offset.beat1':       "beat 1",
    'offset.outro':            "outro",
    'offset.outro_title':      "The song already ends with {own} s of silence; {added} s are added to reach the target.",
    'offset.outro_title_own':  "Nothing is added: the song already ends with {own} s of silence, which is past the target. Shortening it would mean trimming audio, which this app never does.",
    ...
    'settings.silence_hint':  "The starting point for every song: only the missing amount is ever added, and beat-grid alignment goes on top separately. Both can be fine-tuned per song in the BPM view — the intro beat by beat, the outro in half seconds. The ranking criteria ask for 1.5 and 2.",
  ...
  es: {
    ...
    'bpm.outro.more': "Medio segundo más de silencio al final",
    'bpm.outro.less': "Medio segundo menos de silencio al final",
    'bpm.outro.none': "No hay nada que quitar: este es el silencio con el que acaba la propia canción",
    ...
    'offset.beat1':       "beat 1",
    'offset.outro':            "outro",
    'offset.outro_title':      "La canción ya acaba con {own} s de silencio; se añaden {added} s para llegar al objetivo.",
    'offset.outro_title_own':  "No se añade nada: la canción ya acaba con {own} s de silencio, más que el objetivo. Acortarlo obligaría a recortar audio, y eso no lo hace la app.",
    ...
    'settings.silence_hint':  "Punto de partida de cada canción: solo se añade lo que falte, y la alineación con la rejilla se suma aparte. Las dos se pueden afinar por canción en la vista de BPM: la entrada beat a beat, la salida de medio en medio segundo. El ranking criteria pide 1,5 y 2.",
  ...
  fr: {
    ...
    'bpm.outro.more': "Une demi-seconde de silence en plus à la fin",
    'bpm.outro.less': "Une demi-seconde de silence en moins à la fin",
    'bpm.outro.none': "Rien à retirer — c'est le silence par lequel la chanson finit elle-même",
    ...
    'offset.outro':            "outro",
    'offset.outro_title':      "La chanson finit déjà par {own} s de silence ; {added} s sont ajoutées pour atteindre la cible.",
    'offset.outro_title_own':  "Rien n'est ajouté : la chanson finit déjà par {own} s de silence, au-delà de la cible. Raccourcir imposerait de couper l'audio, ce que l'app ne fait jamais.",
    ...
    'settings.silence_hint':  "Point de départ de chaque chanson : seul ce qui manque est ajouté, et l'alignement sur la grille s'ajoute séparément. Les deux s'ajustent par chanson dans la vue BPM : l'intro temps par temps, la fin par demi-secondes. Les critères demandent 1,5 et 2.",
  ...
  de: {
    ...
    'bpm.outro.more': "Eine halbe Sekunde mehr Stille am Ende",
    'bpm.outro.less': "Eine halbe Sekunde weniger Stille am Ende",
    'bpm.outro.none': "Nichts zu entfernen — so viel Stille hat der Song selbst am Ende",
    ...
    'offset.beat1':       "Beat 1",
    'offset.outro':            "Outro",
    'offset.outro_title':      "Der Song endet schon mit {own} s Stille; {added} s werden ergänzt, um das Ziel zu erreichen.",
    'offset.outro_title_own':  "Es wird nichts ergänzt: der Song endet schon mit {own} s Stille, mehr als das Ziel. Kürzer geht nur, indem Audio abgeschnitten wird — das macht die App nie.",
    ...
    'settings.silence_intro': "Intro",
    'settings.silence_outro': "Outro",
    'settings.silence_hint':  "Ausgangspunkt für jeden Song: es wird nur das Fehlende ergänzt, und die Ausrichtung am Beat-Raster kommt separat obendrauf. Beide lassen sich in der BPM-Ansicht pro Song anpassen — das Intro beatweise, das Outro in halben Sekunden. Die Kriterien verlangen 1,5 und 2.",
  ...
  pt: {
    ...
    'bpm.outro.more': "Meio segundo mais de silêncio no fim",
    'bpm.outro.less': "Meio segundo menos de silêncio no fim",
    'bpm.outro.none': "Não há nada para remover: este é o silêncio com que a própria música acaba",
    ...
    'offset.beat1':       "beat 1",
    'offset.outro':            "outro",
    'offset.outro_title':      "A música já termina com {own} s de silêncio; são adicionados {added} s para chegar ao objetivo.",
    'offset.outro_title_own':  "Não é adicionado nada: a música já termina com {own} s de silêncio, mais do que o objetivo. Encurtar obrigaria a cortar áudio, e a app nunca faz isso.",
    ...
    'settings.silence_hint':  "Ponto de partida de cada música: só se acrescenta o que falta, e o alinhamento com a grelha soma-se à parte. Os dois podem ser afinados por música na vista de BPM: o início beat a beat, o fim de meio em meio segundo. O ranking criteria pede 1,5 e 2.",
